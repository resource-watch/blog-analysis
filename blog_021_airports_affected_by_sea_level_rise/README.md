...
If you have a Google Earth Engine account, the code used for the analysis can be viewed [in Google Earth Engine](https://code.earthengine.google.com/5b7bd8baed8d29cb46f787afaeef41eb). If you do not have an account, you can still view a copy of the code [here](blog_021_airports_affected_by_sea_level_rise/EarthEnginecode.md).

You can find the results of this analysis in the [Final Results folder](blog_021_airports_affected_by_sea_level_rise/Final%20Results).
