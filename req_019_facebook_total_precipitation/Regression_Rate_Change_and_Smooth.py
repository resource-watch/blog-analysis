...
# List state-level annual precipitation file
file_list = ['GPCC_annual_state_'+ country +'.csv' for country in country_list]

# Define years for linear regression
years = np.arange(1901,2020)
# Define state-level metadata columns
meta_list = ['CC_1', 'ENGTYPE_1', 'GID_0', 'GID_1', 'HASC_1', 'NAME_0', 'NAME_1','NL_NAME_1', 'TYPE_1', 'VARNAME_1']

# Loop through each state-level file 
